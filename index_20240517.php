        ...
        <section class="pg_map_wrap num_point_map" id="">
            <div class="pg_map_inner" id="map_info_box">
                ...
                <?php if ($_SERVER['REMOTE_ADDR'] == '115.93.39.5') { ?>
                    <div class="point_wrap point_myplt" style="top:12rem">
                        <button type="button" class="btn point point_mypoint" onclick="showAd()" id="showAdBtn">
                            <span class="point_inner">
                                <span class="point_txt"><img src="./img/ico_arm_on.png" width="35px" alt="showAd" id="showAdBtn" /></span>
                            </span>
                        </button>
                    </div>
                <? } ?>
