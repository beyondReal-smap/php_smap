                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data == 'Y') {
                            ...
                            // jalert_url('해당 일정이 삭제되었습니다.', './schedule', '일정삭제');
                        }
                    },
                    error: function(err) {
                        console.log(err);
    ...
    <div class="modal-dialog modal-default modal-dialog-scrollable modal-dialog-centered">
        <div class="modal-content">
            <form method="post" name="frm_schedule_member" id="frm_schedule_member">
                ...
                <div class="modal-body scroll_bar_y px-0" style="height:380px;min-height:380px;" id="schedule_member_content"></div>
                <div class="modal-footer border-0 p-0">
    ...
    <div class="modal-dialog modal-default modal-dialog-scrollable modal-dialog-centered" style="overflow-y: initial !important">
        <div class="modal-content">
            <form method="post" name="frm_schedule_location" id="frm_schedule_location">
                ...
                <div class="modal-body scroll_bar_y pt-0" style="max-height: calc(100vh - 200px); overflow-x: hidden; overflow-y: auto;">
