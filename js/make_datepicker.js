(function (factory) {
        ...
        var picker = {},
            ...
            getDatePickerTemplate = function () {
                ...
                return [
                    ...
                    $("<div>")
                        ...
                        .append($("<table>").addClass("table-condensed").append(headTemplate.clone()).append(contTemplate.clone())),
                    $("<div>")
            ...
            getTimePickerMainTemplate = function () {
                ...
                if (isEnabled("h")) {
                    topRow
                        ...
                        .append($("<span>").addClass("timepicker-hour").addClass("active").attr({ "data-time-component": "hours", title: options.tooltips.pickHour }).attr("data-action", "showHours"))
                ...
                if (isEnabled("m")) {
                    ...
                    middleRow
                        .append($("<a>").attr({ href: "#", tabindex: "-1", title: options.tooltips.incrementMinute }).addClass("btn").attr("data-action", "incrementMinutes").append($("<span>").addClass(options.icons.up)))
                        .append($("<span>").addClass("timepicker-minute").attr({ "data-time-component": "minutes", title: options.tooltips.pickMinute }).attr("data-action", "showMinutes"))
                        .append($("<a>").attr({ href: "#", tabindex: "-1", title: options.tooltips.decrementMinute }).addClass("btn").attr("data-action", "decrementMinutes").append($("<span>").addClass(options.icons.down)));
                }
                if (isEnabled("s")) {
                    if (isEnabled("m")) {
                        //      topRow.append($('<span>').addClass('separator'));
                    ...
                    bottomRow
                        .append($("<a>").attr({ href: "#", tabindex: "-1", title: options.tooltips.incrementSecond }).addClass("btn").attr("data-action", "incrementSeconds").append($("<span>").addClass(options.icons.up)))
                        .append($("<span>").addClass("timepicker-second").attr({ "data-time-component": "seconds", title: options.tooltips.pickSecond }).attr("data-action", "showSeconds"))
                        .append($("<a>").attr({ href: "#", tabindex: "-1", title: options.tooltips.decrementSecond }).addClass("btn").attr("data-action", "decrementSeconds").append($("<span>").addClass(options.icons.down)));
                }
                ...
                if (!use24Hours) {
                    ...
                    bottomRow.append(
                        $("<span>")
                            ...
                            .addClass("ampmvalue")
                            .append($("<button>").addClass("btn btn-primary").attr("data-action", "togglePeriodam"))
                            .append($("<button>").addClass("btn btn-primary").attr("data-action", "togglePeriodpm"))
                    );
                }

                return $("<div>").addClass("timepicker-picker").append([topRow]).append([separator1]).append([middleRow]).append([separator2]).append([bottomRow]).append([amapview]);
                //.append([bottomRow])
            },
            getTimePickerTemplate = function () {
                var hoursView = $("<div>").addClass("timepicker-hours").append($("<div>").addClass("table-condensed clockpickerr")),
                    minutesView = $("<div>").addClass("timepicker-minutes").append($("<div>").addClass("table-condensed clockpickerminute")),
                    secondsView = $("<div>").addClass("timepicker-seconds").append($("<div>").addClass("table-condensed clockpickerseconds")),
            ...
            getToolbar = function () {
                ...
                if (options.showTodayButton) {
                    row.push($("<a>").attr({ "data-action": "today", title: options.tooltips.today }).append($("<span>").addClass(options.icons.today)));
                }
                if (!options.sideBySide && hasDate() && hasTime()) {
                    row.push($("<a>").attr({ "data-action": "togglePicker", title: options.tooltips.selectTime }).append($("<span>").addClass(options.icons.time)));
                }
            ...
            getTemplate = function () {
                ...
                if (options.sideBySide && hasDate() && hasTime()) {
                    ...
                    template.append($("<div>").addClass("row").append(dateView.addClass("col-sm-12")).append(timeView.addClass("col-sm-12")));
            ...
            fillMonths = function () {
                ...
                while (monthsShort.isSame(viewDate, "y")) {
                    spans.push($("<span style='width:32%;float:left;'>").attr("data-action", "selectMonth").addClass("month").text(monthsShort.format("MMM")));
                    monthsShort.add(1, "M");
                }
            ...
            updateYears = function () {
                ...
                while (!startYear.isAfter(endYear, "y")) {
                    html += '<span data-action="selectYear" style="width:32%;float:left;" class="year ' + (startYear.isSame(date, "y") && !unset ? " active" : "") + (!isValid(startYear, "y") ? " disabled" : "") + '">' + startYear.year() + "</span>";
                    startYear.add(1, "y");
                }
            ...
            updateDecades = function () {
                ...
                while (!startDecade.isAfter(endDecade, "y")) {
                    ...
                    html +=
                        '<span data-action="selectDecade" style="width:48%;float:left;" class="decade' +
            ...
            fillDate = function () {
                ...
                for (i = 0; i < 42; i++) {
                    ...
                    row.append('<td data-action="selectDay" data-day="' + currentDate.format("L") + '" class="' + clsNames.join(" ") + '"><span></span>' + currentDate.date() + "</td>");
                    currentDate.add(1, "d");
                }
    ...
    $.fn.datetimepicker.defaults = {
        ...
        icons: {
            time: "mdi mdi-timer",
            date: "mdi mdi-timetable",
            up: "mdi mdi-arrow-up-circle-outline",
            down: "mdi mdi-arrow-down-drop-circle-outline",
            previous: "mdi mdi-arrow-left-circle-outline",
            next: "mdi mdi-arrow-right-circle-outline",
            today: "mdi mdi-calendar-today",
            clear: "mdi mdi-notification-clear-all",
