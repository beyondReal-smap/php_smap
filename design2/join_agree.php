    ...
    <div class="mt-4">
        ...
        <form action="" class="">
            ...
            <div class="d-flex align-items-center justify-content-between pt_07">
                ...
                <a href="terms1.php" class="py-3 pl-3 pr-2 cursor_pointer flex-shrink-0" >
            ...
            <div class="b_botton">
                <button type="button" class="btn w-100 rounded btn-primary btn-lg btn-block" onclick="location.href='join_done.php'">동의했어요!</button>
            </div>
        </form>
    </div>
</div>