...
<div class="container sub_pg psn_wrap">
    <div class="mt-4">
        ...
        <div class="mt_45 psn_textwrap">
            <ul class="">
                ...
                <li class="d-flex fs_13 py-4 d-flex">
                    <p class="psn_tit flex-shrink-0 fw_700 text_dynamic line_h1_3 mr-3">배너티 절전 제외
                    앱 등록</p>
    ...
    <div class="b_botton">
        <button type="button" class="btn w-100 rounded btn-primary btn-lg btn-block" onclick="location.href='join_entry.php.php'">모든 권한 설정하기</button>
    </div>
</div>