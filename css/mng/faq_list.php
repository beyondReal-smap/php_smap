            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" name="frm_list" id="frm_list" onsubmit="return false;">
                        ...
                        <input type="hidden" name="obj_list" id="obj_list" value="faq_list_box" />
                        <input type="hidden" name="obj_frm" id="obj_frm" value="frm_list" />
                        <input type="hidden" name="obj_uri" id="obj_uri" value="./faq_update" />
                            ...
                            <div class="col-xl-9">
                                <div class="float-right form-inline">
                                    <div class="form-group mx-1">
                                        <select name="sel_fct_idx" id="sel_fct_idx" class="form-control form-control-sm">
                                    ...
                                    <div class="form-group mx-1">
                                        <input type="button" class="btn btn-secondary" value="초기화" onclick="f_localStorage_reset_go('./faq_list');" />
                                    </div>

                                    <div class="form-group mx-1">
                                        <input type="button" class="btn btn-primary" value="신규등록" onclick="f_localStorage_reset_go('./faq_form');" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <?php } ?>
                    <?php if ($_POST['sel_fct_idx']) { ?>
                    $('#sel_fct_idx').val('<?=$_POST['sel_fct_idx']?>');
                    <?php } ?>
                    </script>

                    <div id="faq_list_box"></div>
                </div>
            </div>
        </div>
    </div>
