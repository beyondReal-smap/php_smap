            ...
            <div class="d-flex flex-column justify-content-center min_h_100">
                ...
                <div class="left_cont">
                    ...
                    <div class="form-row mt-5 mb-5 pb-5">
                        ...
                        <div class="col">
                            <a type="button" class="btn btn-primary btn-lg btn-block rounded" href="https://youtu.be/Bvzaz5vFyAo?si=iOdJQhSwVH91LC2g" target="_blank">그룹생성<br>Guide</a>
                        </div>
                        <div class="col">
                            <a type="button" class="btn btn-primary btn-lg btn-block rounded" href="https://youtu.be/JgZov6z0Htg?si=AZqyBkCijeIdOJ5b" target="_blank">초대수락<br>Guide</a>
                        </div>
                    </div>
