...
<div class="container sub_pg">
    <div class="mt-4">
        <p class="tit_h1 wh_pre line_h1_3">입력하신 이메일 주소로
            인증번호를 보냈어요.</p>
        <form action="">
            <div class="mt-5">
                <div class="ip_wr">
            ...
            <div class="b_botton">
                <button type="button" class="btn w-100 rounded btn-primary btn-lg btn-block " onclick="location.href='form_password.php'">입력했어요!</button>
            </div>
        </form>
    </div>
</div>