<div class="b_menu">
    <ul>
        ...
        <li <?php if ($b_menu === '4') { ?> class="on" <?php } ?>>
            <a href="./location.php">
                <div class="b_menu_img d-flex flex-column">
                    <img src="./img/ic_b_menu4_off.png" alt="위치 아이콘" class="img_off flex-shrink-0">
                    <img src="./img/ic_b_menu4_on.png" alt="위치 아이콘" class="img_on flex-shrink-0">
                </div>
                <p class="">위치</p>
            </a>
        </li>
        <li <?php if ($b_menu === '5') { ?> class="on" <?php } ?>>
            <a href="./setting.php">
                <div class="b_menu_img d-flex flex-column">
                    <img src="./img/ic_b_menu5_off.png" alt="설정 아이콘" class="img_off flex-shrink-0">
                    <img src="./img/ic_b_menu5_on.png" alt="설정 아이콘" class="img_on flex-shrink-0">
                </div>
                <p class="">설정</p>
            </a>
        </li>
