        ...
        <div class="fixed_top">
            <div class="bg-secondary px_16 py-4 d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    <p class="fs_16 fw_800 mr-2">아가들<span class="fs_15"> (2)</span></p>
                    <!-- 오너일때 필요 -->
                ...
                <!--맴버 / 그룹리더 -->
                <button type="button" class="btn fs_14 fw_500 text_gray h_fit_im px-0 py-0 mx-0 my-0 text-right" data-toggle="modal" data-target="#group_out_modal">그룹나가기</button>
                <!--그룹오너 -->
                ...
                <div class="py_16 d-flex align-items-center justify-content-between border-bottom">
                    <div class="w_fit">
                        <a href="#" class="d-flex align-items-center">
                            ...
                            <div>
                                <p class="fs_14 fw_500 text_dynamic line_h1_2 mr-2">오너가 보는 리스트</p>
                                <div class="d-flex align-items-center flex-wrap ">
                    ...
                    <div class="d-flex align-items-center justify-content-end">
                        <button type="button" class="btn text_light_gray fs_12 fw_500 text_gray_600 rounded_04 bg_gray px-2 py-2 w_fit h_fit_im border ml-3" data-toggle="modal" data-target="#leader_delete_modal">리더제외하기</button>
                        <button type="button" class="btn text_light_gray fs_22 px-2 py-2 ml-3"><i class="xi-drag-handle"></i></button>
                        <button type="button" class="btn text_light_gray fs_20 px-2 py-2 ml-3" data-toggle="modal" data-target="#mem_out_modal"><i class="xi-close"></i></button>
                    </div>
                </div>
                <div class="py_16 d-flex align-items-center justify-content-between border-bottom">
                    <div class="w_fit">
                        <a href="#" class="d-flex align-items-center">
                            ...
                            <div>
                                <p class="fs_14 fw_500 text_dynamic line_h1_2 mr-2">리더가 보는 리스트 김상추</p>
                                <div class="d-flex align-items-center flex-wrap ">
                                    <p class="fs_12 fw_400 text_dynamic text-primary line_h1_2 mt-1">오너</p>
                                </div>
                            </div>
                ...
                <div class="py_16 d-flex align-items-center justify-content-between border-bottom">
                    <div class="w_fit">
                        <a href="#" class="d-flex align-items-center">
                            ...
                            <div>
                                <p class="fs_14 fw_500 text_dynamic line_h1_2 mr-2">리더가 보는 리스트 노깻잎</p>
                                <div class="d-flex align-items-center flex-wrap ">
                ...
                <div class="py_16 d-flex align-items-center justify-content-between border-bottom">
                    <div class="w_fit">
                        <a href="#" class="d-flex align-items-center">
                            ...
                            <div>
                                <p class="fs_14 fw_500 text_dynamic line_h1_2 mr-2">맴버가보는 리스트 하구름</p>
                                <div class="d-flex align-items-center flex-wrap ">
                                    <p class="fs_12 fw_400 text_dynamic text-primary line_h1_2 mt-1">오너</p>
                                </div>
                            </div>
                ...
                <div class="py_16 d-flex align-items-center justify-content-between border-bottom">
                    <div class="w_fit">
                        <a href="#" class="d-flex align-items-center">
                            ...
                            <div>
                                <p class="fs_14 fw_500 text_dynamic line_h1_2 mr-2">맴버가보는 리스트</p>
                                <div class="d-flex align-items-center flex-wrap ">
                                    <p class="fs_12 fw_400 text_dynamic text-primary line_h1_2 mt-1"></p>
                                </div>
                            </div>
                ...
                <div class="py_16 d-flex align-items-center justify-content-between border-bottom">
                    <div class="w_fit">
                        <a href="#" class="d-flex align-items-center">
                            ...
                            <div>
                                <p class="fs_14 fw_500 text_dynamic line_h1_2 mr-2">정지민</p>
                                <div class="d-flex align-items-center flex-wrap ">
                                    <p class="fs_12 fw_400 text_dynamic text-primary line_h1_2 mt-1"></p>
                                </div>
                            </div>
                    ...
                    <div class="d-flex align-items-center justify-content-end">
                        <button type="button" class="btn text_light_gray fs_12 fw_500 text_gray_600 rounded_04 bg_gray px-2 py-2 w_fit h_fit_im border ml-3" data-toggle="modal" data-target="#leader_add_modal">리더추가하기</button>
                        <button type="button" class="btn text_light_gray fs_22 px-2 py-2 ml-3"><i class="xi-drag-handle"></i></button>
                        <button type="button" class="btn text_light_gray fs_20 px-2 py-2 ml-3" data-toggle="modal" data-target="#mem_out_modal"><i class="xi-close"></i></button>
                    </div>
                </div>
                <div class="py_16 d-flex align-items-center justify-content-between border-bottom">
                    <div class="w_fit">
                        <a href="#" class="d-flex align-items-center">
                            ...
                            <div>
                                <p class="fs_14 fw_500 text_dynamic line_h1_2 mr-2">한승호</p>
                                <div class="d-flex align-items-center flex-wrap ">
                                    <p class="fs_12 fw_400 text_dynamic text-primary line_h1_2 mt-1"></p>
                                </div>
                            </div>
                ...
                <div class="py_16 d-flex align-items-center justify-content-between border-bottom">
                    <div class="w_fit">
                        <a href="#" class="d-flex align-items-center">
                            ...
                            <div>
                                <p class="fs_14 fw_500 text_dynamic line_h1_2 mr-2">이민준</p>
                                <div class="d-flex align-items-center flex-wrap ">
                                    <p class="fs_12 fw_400 text_dynamic text-primary line_h1_2 mt-1"></p>
                                </div>
                            </div>
