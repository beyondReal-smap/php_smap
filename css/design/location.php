        ...
        <div class="map_wrap_h_div">
            ...
            <div class="map_ab">
                ...
                <div class="point point4">
                    <img src="./img/map_recom_point.png" width="26px" alt="이미지"/>
                    <div class="infobox rounded-sm bg-white px_08 py_08">
                        <p class="fs_12 fw_500 fc_orange text_dynamic line_h1_2 ">추천장소이름 추천 장소 이름</p>
                        <p class="fs_9 text_dynamic mt-2">서울 영등포구 여의대로56</p>
                        <p class="fs_9 text_dynamic mt-2">010-1234-1324</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bg_main px_20 py_20">
                ...
                <div class="border_orange rounded-lg px_16 py_16 d-flex align-items-center justify-content-between mb-3">
                    <div class="mr-2">
                        ...
                        <p class="fs_14 fw_600 text_dynamic line_h1_2 py_02">광화문 광화문 광화문 이름</p>
                        <p class="line1_text fs_13 fw_400 text_dynamic line_h1_4 py_02">서울 영등포구 선유로11길 서울 영등포구 선유로11길 서울 영등포구 선유로11길</p>
                        <p class="line1_text fs_13 fw_400 text_dynamic line_h1_4 py_02">010-1234-1234</p>
                    </div>
