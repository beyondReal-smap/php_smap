...
<style>
    ...
    .log_wrap .sch_cld_wrap .location_info_box {
        padding: 1rem 0;
    }
...
<div class="container sub_pg  log_wrap px-0">
    <!-- 달력 -->
    <section class="sch_cld_wrap bg-white pt-1 pb-2">
            ...
            <div class="grp_wrap">
                ...
                <div class="my-3">
                    <div class="border bg-white rounded-lg px_16 py_16">
                        ...
                        <!-- 위치조정 슬라이드 -->
                        <div class="loc_rog_adj mt-4">
                            <p class="fs_16 fw_600">위치조정 슬라이드</p>
                            <div class="pt-4">
                                <input type="range" class="custom-range" id="timeSlider">
                            </div>
                        </div>
                    </div>
                </div>
