...
if ($_POST['act'] == "recom_list") {
    ...
    if ($mem_row['mt_level'] == '2') {
        ...
        $ad_first_check = $next_ad_count / 9999; //24.05.27 광고수정
        $ad_check = $next_ad_count % 9999;       //24.05.27 광고수정
...
";    
    ...
    $cnt = count($slt_list);
    ?>
    <div class="px_16" style="margin-bottom: 10px;">
        <div class="border bg-white rounded-lg px_16 py_16">
            <p class="fs_16 fw_600 mb-3">내장소</p>
...
<? } elseif ($_POST['act'] == "location_delete") {
    ...
    if ($mem_row) {
        ...
        if ($sgdt_row['sgdt_idx']) {
            ...
            if (($slt_count < 2 && $mem_row['mt_level'] == 2) || $mem_row['mt_level'] == 5) {
                unset($arr_query);
                $arr_query = array(
