...
(function () {
        ...
        compareStrings: function (sString1, sString2) {
            ...
            if (sString1 !== null && sString1 !== undefined && sString2 !== null && sString2 !== undefined) {
                if (typeof sString1 === "string" && typeof sString2 === "string") {
                    if (sString1.toLocaleLowerCase() === sString2.toLocaleLowerCase()) return true;
                }
                return false;
            } else {
                if ((sString1 === null && sString2 === null) || (sString1 === undefined && sString2 === undefined)) return true;
                else return false;
            }
        },
    ...
    function AnyPicker(element, options) {
        ...
        if ($.CF.compareStrings(apo.setting.theme, "Android")) {
            ...
            if (apo.tmp.bIsiPad && $.CF.compareStrings(apo.setting.layout, "popup")) apo.setting.layout = "popover";
        ...
        if (apo.tmp.selectedDate === null) apo.tmp.selectedDate = $.AnyPicker.extra.dToday;
        if (apo.setting.maxYear === 0) apo.setting.maxYear = $.AnyPicker.extra.dToday.getFullYear();
        if ($.CF.isValid(apo.setting.components) && apo.tmp.numOfComp === 0) apo.tmp.numOfComp = apo.setting.components.length;
    ...
    AnyPicker.prototype = {
        ...
        init: function () {
            ...
            if ($.CF.isValid(apo.elem)) {
                ...
                else if (apo.tmp.sElemTag === "ul" || apo.tmp.sElemTag === "ol" || apo.tmp.sElemTag === "dl") apo.tmp.oElemValid.bIsListItem = true;
                else if (apo.tmp.sElemTag === "select") apo.tmp.oElemValid.bIsSelect = true;
            }

            if ($.CF.isValid(apo.setting.inputElement)) {
                apo.tmp.sInputElemTag = $(apo.setting.inputElement).prop("tagName").toLowerCase();
                if (apo.tmp.sInputElemTag === "input") apo.tmp.oInputElemValid.bIsInput = true;
                else if (apo.tmp.sInputElemTag === "ul" || apo.tmp.sInputElemTag === "ol" || apo.tmp.sInputElemTag === "dl") apo.tmp.oInputElemValid.bIsListItem = true;
                else if (apo.tmp.sInputElemTag === "select") apo.tmp.oInputElemValid.bIsSelect = true;
            ...
            if (apo.tmp.sInputElemTag !== "" && !(apo.tmp.oInputElemValid.bIsListItem || apo.tmp.oInputElemValid.bIsSelect)) {
                ...
                if (apo.tmp.oInputElemValid.bIsInput) {
                    ...
                    $oInput.on("keydown." + apo.setting.timestamp, function (e) {
                        if ((e.keyCode ? e.keyCode : e.which) === "9") $.AnyPicker.tempDefaults.tabKey = true;
                    });
                } else {
        ...
        _inputElementClicked: function (e) {
            ...
            if (document.activeElement === apo.tmp.prevActive && document.activeElement === apo.setting.inputElement) return;
        ...
        showOrHidePicker: function (sElemValue) {
            ...
            if ($(apo.tmp.overlaySelector).length > 0) apo._hidePicker();
                ...
                if (!$.CF.isValid(apo.setting.onBeforeShowPicker)) apo._showPicker();
                else {
        ...
        _showPicker: function () {
            ...
            if ($.CF.isValid(apo.tmp.sTooltip)) sTemp += "<span class='ap-tooltip ap-tooltip-" + apo.tmp.sTooltip + "'></span>";
            ...
            if (bAddSectionFooterFixedTop) {
                ...
                if ($.CF.compareStrings(apo.setting.theme, "Default")) sTemp += "<div class='ap-button-cont'></div>";
                sTemp += "</div>";
            }

            sTemp += "<div class='ap-content'>";

            if (apo.setting.viewSections.contentTop.length > 0) sTemp += "<div class='ap-content-top'></div>";
            ...
            if (apo.setting.viewSections.contentBottom.length > 0) sTemp += "<div class='ap-content-bottom'></div>";
            ...
            if ($.AnyPicker.extra.bHasCSSAnimation) {
                ...
                if ($.CF.compareStrings(apo.setting.layout, "fixed")) {
                    if ($.CF.compareStrings(apo.setting.vAlign, "top")) $(apo.tmp.overlaySelector).find(".ap-cont").addClass("ap-top-slide-down");
                    else if ($.CF.compareStrings(apo.setting.vAlign, "bottom")) $(apo.tmp.overlaySelector).find(".ap-cont").addClass("ap-bottom-slide-up");
                }
            ...
            if ($.CF.isValid(apo.setting.onShowPicker)) apo.setting.onShowPicker.call(apo);
            ...
            if ($.CF.compareStrings(apo.setting.mode, "datetime") && apo.tmp.sDateTimeMode === "datetime") apo._setDateTimeTabs(apo.tmp.sDateTimeTab);
        },
        ...
        _hidePicker: function () {
            ...
            if ($(apo.tmp.overlaySelector).length > 0) {
                if ($.CF.isValid(apo.setting.onBeforeHidePicker)) apo.setting.onBeforeHidePicker.call(apo);

                if ($.AnyPicker.extra.bHasCSSAnimation) {
                    $(apo.tmp.overlaySelector).addClass("ap-hide");
                    if ($.CF.compareStrings(apo.setting.layout, "fixed")) {
                        if ($.CF.compareStrings(apo.setting.vAlign, "top")) $(apo.tmp.overlaySelector).find(".ap-cont").addClass("ap-top-slide-up");
                        else if ($.CF.compareStrings(apo.setting.vAlign, "bottom")) $(apo.tmp.overlaySelector).find(".ap-cont").addClass("ap-bottom-slide-down");
                    }
                    setTimeout(function () {
                ...
                if ($.CF.isValid(apo.setting.onHidePicker)) apo.setting.onHidePicker.call(apo);
            }
        },
        ...
        _adjustPicker: function (iNumOfComp) {
            ...
            if ($.CF.compareStrings(apo.setting.theme, "Windows")) {
                ...
                if (!apo.setting.componentsCoverFullWidth) apo.setting.rowHeight = iRowWidth;
                else {
            ...
            if ($.CF.compareStrings(apo.setting.layout, "popover")) {
                ...
                if ($.CF.compareStrings(apo.setting.hAlign, "center")) iLeft = iRelElemWidth > iWidth ? iLeft + iWidth / 2 : iRelElemWidth === iWidth ? iLeft : iLeft - iWidth / 2;
                else if ($.CF.compareStrings(apo.setting.hAlign, "right")) iLeft = iLeft - iWidth;
                ...
                if ($.CF.compareStrings(apo.setting.vAlign, "top")) $(apo.tmp.overlaySelector + " .ap-cont").css({ top: -1000 });
                else if ($.CF.compareStrings(apo.setting.vAlign, "bottom")) $(apo.tmp.overlaySelector + " .ap-cont").css({ bottom: -1000 });
            }
        },
            ...
            for (iTempIndex1 = 0; iTempIndex1 < $.AnyPicker.extra.sArrViewSections.length; iTempIndex1++) {
                ...
                if (sArrComponents.length > 0) {
                    for (iTempIndex2 = 0; iTempIndex2 < sArrComponents.length; iTempIndex2++) {
                        ...
                        if (bWindowsTheme && $.CF.isValid(oComp.markupContentWindows)) $oCompElem.html(oComp.markupContentWindows);
                        ...
                        if (oComp !== undefined && oComp !== null && oComp !== "") {
                            if ($.CF.compareStrings(sViewSection, "header")) {
                                ...
                                if ($.CF.compareStrings(oComp.type, "Button") && $.CF.compareDataType(oComp.action, "function")) $oCompElem.on("click." + apo.setting.timestamp, { apo: apo }, oComp.action); // Bind Action
                                ...
                                else $(apo.tmp.overlaySelector).find(".ap-footer").append($oCompElem); // Append Component
                                if ($.CF.compareStrings(oComp.type, "Button") && $.CF.compareDataType(oComp.action, "function")) $oCompElem.on("click." + apo.setting.timestamp, { apo: apo }, oComp.action); // Bind Action
                            }

                            if ($.CF.compareStrings(sComp, "headerTitle") && $.CF.compareStrings(oComp.contentBehaviour, "Static")) $(apo.tmp.overlaySelector).find(".ap-header__title").text(apo.setting.i18n.headerTitle);

                            if ($.CF.compareStrings(sComp, "setButton")) {
                                if (!bWindowsTheme || (bWindowsTheme && apo.tmp.bModified.set)) $oCompElem.text(apo.setting.i18n.setButton);
                                else if (bWindowsTheme && !apo.tmp.bModified.set) $oCompElem.find(".ap-button-text").text(apo.setting.i18n.setButton);
                            } else if ($.CF.compareStrings(sComp, "clearButton")) {
                                if (!bWindowsTheme || (bWindowsTheme && apo.tmp.bModified.clear)) $oCompElem.text(apo.setting.i18n.clearButton);
                                else if (bWindowsTheme && !apo.tmp.bModified.clear) $oCompElem.find(".ap-button-text").text(apo.setting.i18n.clearButton);
                            } else if ($.CF.compareStrings(sComp, "nowButton")) {
                                if (!bWindowsTheme || (bWindowsTheme && apo.tmp.bModified.now)) $oCompElem.text(apo.setting.i18n.nowButton);
                                else if (bWindowsTheme && !apo.tmp.bModified.now) $oCompElem.find(".ap-button-text").text(apo.setting.i18n.nowButton);
                            } else if ($.CF.compareStrings(sComp, "cancelButton")) {
                                if (!bWindowsTheme || (bWindowsTheme && apo.tmp.bModified.cancel)) $oCompElem.text(apo.setting.i18n.cancelButton);
                                else if (bWindowsTheme && !apo.tmp.bModified.cancel) $oCompElem.find(".ap-button-text").text(apo.setting.i18n.cancelButton);
                            }

                            if ($.CF.compareStrings(oComp.type, "Button")) {
                                if (!$.CF.compareDataType(oComp.action, "function")) {
                                    if ($.CF.compareStrings(sComp, "setButton")) $oCompElem.on("click." + apo.setting.timestamp, { apo: apo }, apo._setButtonAction);
                                    else if ($.CF.compareStrings(sComp, "clearButton")) $oCompElem.on("click." + apo.setting.timestamp, { apo: apo }, apo._clearButtonAction);
                                    else if ($.CF.compareStrings(sComp, "nowButton")) $oCompElem.on("click." + apo.setting.timestamp, { apo: apo }, apo._nowButtonAction);
                                    else if ($.CF.compareStrings(sComp, "cancelButton")) $oCompElem.on("click." + apo.setting.timestamp, { apo: apo }, apo._cancelButtonAction);
                                }
                            }
                        }
                    }
        ...
        _setDateTimeTabs: function (sSelectedTab) {
            ...
            if ($.CF.compareStrings(apo.setting.theme, "Windows")) apo._adjustPicker($oeSelectedTabs.length);
        },
                ...
                $(apo.elem)
                    ...
                    .each(function () {
                        ...
                        if (apo.tmp.selectedValues.values[0].val === sValue) {
                            if (apo.tmp.oElemValid.bIsSelect) $oChildElem.attr("selected", true);
                            else if (apo.tmp.oElemValid.bIsListItem) $oChildElem.attr("data-selected", true);
                        } else {
                            if (apo.tmp.oElemValid.bIsSelect) $oChildElem.attr("selected", false);
                            else if (apo.tmp.oElemValid.bIsListItem) $oChildElem.attr("data-selected", false);
                        }
                    });
            }

            if ($.CF.isValid(apo.setting.setOutput)) apo.setting.setOutput.call(apo, sOutput, apo.tmp.selectedValues, apo.tmp.bIsManualDraggingAfterShow);
            else {
                ...
                if ($.CF.isValid(apo.setting.onSetOutput)) apo.setting.onSetOutput.call(apo, sOutput, apo.tmp.selectedValues, apo.tmp.bIsManualDraggingAfterShow);
            }
        },
        ...
        _setButtonAction: function (e) {
            ...
            if ($.CF.isValid(apo.setting.buttonClicked)) apo.setting.buttonClicked.call(apo, "set");
        },
        ...
        _clearButtonAction: function (e) {
            ...
            if ($.CF.isValid(apo.setting.buttonClicked)) apo.setting.buttonClicked.call(apo, "clear");
        },
        ...
        _nowButtonAction: function (e) {
            ...
            if ($.CF.isValid(apo.setting.buttonClicked)) apo.setting.buttonClicked.call(apo, "now");
        },
        ...
        _cancelButtonAction: function (e) {
            ...
            if ($.CF.isValid(apo.setting.buttonClicked)) apo.setting.buttonClicked.call(apo, "cancel");
        },
    ...
    AnyPicker.prototype = $.extend(AnyPicker.prototype, {
        __initComponents: function () {
            ...
            if (!apo.tmp.bFirst) {
                if ($.CF.compareStrings(apo.setting.mode, "select")) apo.__setComponentsOfSelect();
                else if ($.CF.compareStrings(apo.setting.mode, "datetime")) apo.__setComponentsOfDateTimePicker();
        ...
        reloadComponent: function (iComp, bSingleLoad) {
            ...
            if ($oeComp.length === 0) sTemp += "<div class='ap-component' id='" + sCompId + "' data-type='" + sType + "' " + (sWidth !== "" ? "style='" + sWidth + ";'" : "") + ">";

            if (!$.CF.compareStrings(apo.setting.theme, "Windows")) {
                if (apo.setting.showComponentLabel) sTemp += "<div class='ap-component-label' " + (sTextAlign !== "" ? "style='" + sTextAlign + ";'" : "") + ">" + oComp.label + "</div>";
            }
            ...
            for (iRowIndex = 0; iRowIndex < oSData.length; iRowIndex++) {
                ...
                if ($.CF.compareStrings(apo.setting.theme, "Windows")) {
                    ...
                    if (!$.CF.isValid(apo.setting.rowView)) sTemp += "<div class='ap-row-content'>";
                }

                if ($.CF.isValid(apo.setting.rowView)) sTemp += apo.setting.rowView.call(apo, iComp, iRowIndex, oSData[iRowIndex]);
                ...
                if ($.CF.compareStrings(apo.setting.theme, "Windows")) sTemp += "</div>";
            ...
            else $(apo.setting.parent).find(".ap-component-section").append(sTemp);
        ...
        _bindEventsToComponent: function (iComp) {
            ...
            if ($.CF.compareStrings(apo.setting.rowsNavigation, "scroller+buttons") || $.CF.compareStrings(apo.setting.rowsNavigation, "scroller")) {
                ...
                if ($.CF.isValid($.AnyPicker.extra.sEndEv)) $oCompCont.on($.AnyPicker.extra.sEndEv + "." + apo.setting.timestamp, oData, apo._onEndDrag);
                if ($.CF.isValid($.AnyPicker.extra.sOutEv)) $oCompCont.on($.AnyPicker.extra.sOutEv + "." + apo.setting.timestamp, oData, apo._onEndDrag);

                if ($.AnyPicker.extra.sMouseWheel.length > 0) {
                    for (var iEventIndex = 0; iEventIndex < $.AnyPicker.extra.sMouseWheel.length; iEventIndex++) $oCompCont.on($.AnyPicker.extra.sMouseWheel[iEventIndex] + "." + apo.setting.timestamp, oData, apo._onMouseWheelScroll);
                }
            }
        ...
        adjustComponents: function () {
            ...
            if (!$.CF.compareStrings(apo.setting.theme, "Windows")) {
                ...
                if (bWidthChanged || bHeightChanged) {
                    ...
                    if ($.CF.compareStrings(apo.setting.layout, "fixed")) $(".ap-cont").css({ position: "absolute" });
                }
                ...
                if ($.CF.compareStrings(apo.setting.layout, "relative")) {
                    ...
                    if ($.CF.compareStrings(apo.setting.vAlign, "top")) $oAPCont.css({ top: iTop });
                }
            }
                    ...
                    if ($.AnyPicker.extra.bHasPointer) {
                        if ($.AnyPicker.extra.bIsTouchDevice) {
                            if (iDSDelta > 10 || iDSDelta < -10) {
                                if ($.CF.compareStrings(apo.setting.theme, "iOS")) iDSDelta = apo.setting.visibleRows * 4 * iDSTS;
                                else {
                                    if (Math.abs(apo.tmp.iTotalDS) > 100) {
                                        if (iDSTS > 0.05) {
                                            if ($.CF.compareStrings(apo.setting.theme, "Windows")) iDSDelta = iDSDelta * iTSDelta * 5;
                            ...
                            if (iDSDelta < 2 && iDSDelta > -2 && iDSDelta !== 0) iDSDelta = iDir * 5;

                            if (iDSDelta > 5 || iDSDelta < -5) iDSDelta = (apo.setting.visibleRows / 10) * 320 * iDSTS;
	...
	*/
        _scrollToPosition: function (sSource, iOffsetNew, bStop, sComp) {
            ...
            if (bStop) iOffsetNew = iPosMod !== 0 ? (iPosMod < iHalfRowHeight ? iOffsetNew - iPosMod : iOffsetNew + (apo.setting.rowHeight - iPosMod)) : iOffsetNew;
            ...
            if ($.AnyPicker.extra.bHasCSS3D) {
                ...
                if (sSource === "drag") {
                    if (iDiffOffset < apo.setting.rowHeight * 6) iTime = iDiffOffset / (apo.setting.rowHeight * 10); // Increase Divisor value to increase speed
                    else {
            ...
            } else apo._performTransition(iComp, sComp, apo.tmp.iOffset, iTime, apo.tmp.iMinTopPos, apo.tmp.iMaxTopPos, iDir, iMinPosBounce, iMaxPosBounce, sSource, bStop);
        },
        ...
        _performTransitionAfter: function (oScrollingData, iMaxPosBounce, iMinPosBounce, sSource, iTime, bStop) {
            ...
            setTimeout(function () {
                ...
                if (bLTMin || bGTMax) {
                    ...
                    if (bStop || iOffsetNew === oScrollingData.iMinTopPos || iOffsetNew === oScrollingData.iMaxTopPos) apo._skipDisabledRow(sSource, oScrollingData.iScrollingComp, iOffsetNew, oScrollingData.iDir);
                }
            }, iTime * 1000);
        },
        ...
        _skipDisabledRowAfter: function (oScrollingData, iOffsetNew, sSource, iTime, bStop) {
            ...
            setTimeout(function () {
                ...
                if (bStop || iOffsetVal === oScrollingData.iMinTopPos || iOffsetVal === oScrollingData.iMaxTopPos) apo._skipDisabledRow(sSource, oScrollingData.iScrollingComp, iOffsetVal, oScrollingData.iDir);
            }, iTime * 1000);
        },
        ...
        __scrollToSelectedRow: function () {
            ...
            if ($.CF.compareStrings(apo.setting.mode, "datetime")) apo.__setSelectedDateTimeInComponent();
            for (iTempIndex = 0; iTempIndex < apo.tmp.numOfComp; iTempIndex++) {
        ...
        setSelectedAndInvalidValuesForRows: function (bSetSelected) {
            ...
            if ($.CF.compareStrings(apo.setting.mode, "select")) apo.__disableInvalidRowsOfSelect();
            else if ($.CF.compareStrings(apo.setting.mode, "datetime")) {
	...
	*/
        ...
        _actionsOnComponentStop: function (sSource, iComp, iRow, iOffset, iDir) {
            ...
            if ($.CF.compareStrings(apo.setting.inputChangeEvent, "onChange")) apo._setOutput();
            ...
            if (apo.tmp.sHeaderTitleType === "DynamicFunction") {
                ...
                if (bSetHeaderTitle) $(apo.tmp.overlaySelector).find(".ap-header__title").text(sHeaderTitle);
            }

            if (sSource !== "auto" && $.CF.isValid(apo.setting.onChange)) apo.setting.onChange.call(apo, iComp, iRow, apo.tmp.selectedValues, sSource);
	...
	*/
        ...
        __setAriaSelectedForRowElement: function (iComp, iOffset, iDir) {
            ...
            if (iDir === 1) iElementIndex = Math.floor(iOffset / apo.setting.rowHeight);
            else if (iDir === -1) iElementIndex = Math.ceil(iOffset / apo.setting.rowHeight);
        ...
        __getValuesOfComponent: function (sValueOf, iComp) {
            ...
            if (sValueOf === "component") {
                if (apo.setting.components[iComp].component === iComp) oValue = apo.setting.components[iComp];
                else {
                    for (iCompIndex = 0; iCompIndex < apo.tmp.numOfComp; iCompIndex++) {
                        if (apo.setting.components[iCompIndex].component === iComp) oValue = apo.setting.components[iCompIndex];
                    }
                }
            } else if (sValueOf === "datasource") {
                if (apo.setting.dataSource[iComp].component === iComp) oValue = apo.setting.dataSource[iComp];
                else {
                    for (iCompIndex = 0; iCompIndex < apo.tmp.numOfComp; iCompIndex++) {
                        if (apo.setting.dataSource[iCompIndex].component === iComp) oValue = apo.setting.dataSource[iCompIndex];
                    }
                }
            }
            ...
            if (apo.setting.dataSource === null) {
                if (apo.tmp.oElemValid.bIsListItem || apo.tmp.oElemValid.bIsSelect) {
                    ...
                    $(apo.elem)
                        ...
                        .each(function () {
                            ...
                            var oSelectData = {
                                ...
                                selected: function () {
                                    if ($oChildElem.attr("selected") || ($oChildElem.attr("data-selected") !== undefined && $oChildElem.attr("data-selected") === "true")) return true;
                                    else return false;
                                },
                                disabled: function () {
                                    if ($oChildElem.attr("disabled") || ($oChildElem.data("disabled") !== undefined && $oChildElem.data("disabled") === "true")) return true;
                                    else return false;
                                },
                            };
                    ...
                    if ($.CF.compareStrings(apo.setting.headerTitle.contentBehaviour, "Dynamic") && $.CF.isValid(apo.setting.headerTitle.format)) {
                        if (typeof apo.setting.headerTitle.format === "function") apo.tmp.sHeaderTitleType = "DynamicFunction";
    ...
    $.AnyPicker = $.extend(true, $.AnyPicker, {
        ...
        extra: {
            ...
            sArrDateComponents: ["d", "dd", "DD", "DDD", "DDDD", "M", "MM", "MMM", "MMMM", "y", "yy", "yyyy", "Y", "YY", "YYYY", "h", "hh", "H", "HH", "m", "mm", "s", "ss", "AA", "A", "aa", "a"],
	...
	*/
        __setComponentsOfDateTimePicker: function () {
            ...
            if (apo.tmp.diffDateTimeFormats) apo.tmp.sArrInputDateTimeFormat = apo._setDateTimeFormatComponentsArray(apo.setting.inputDateTimeFormat);

            //----------------- Code to concatenate separators End -------------

            apo.tmp.sDateTimeRegex = apo._createDateTimeRegex(apo.tmp.sArrDateTimeFormat);
            if (apo.tmp.diffDateTimeFormats) apo.tmp.sInputDateTimeRegex = apo._createDateTimeRegex(apo.tmp.sArrInputDateTimeFormat);
            ...
            if (!apo.tmp.headerTitleDefined && $.CF.compareStrings(apo.setting.mode, "datetime") && !$.CF.compareStrings(apo.setting.theme, "iOS")) {
                ...
                if (apo.tmp.sDateTimeMode === "datetime") {
                    ...
                    else if (apo._formatContains(apo.tmp.sArrDateTimeFormat, ["d", "M", "y|Y", "H", "m"], "and")) apo.setting.headerTitle.format = "dd.MM.yyyy, HH:mm";
                    else apo.setting.headerTitle.format = apo.setting.dateTimeFormat;
                } else if (apo.tmp.sDateTimeMode === "date") {
                    if (apo._formatContains(apo.tmp.sArrDateTimeFormat, ["d", "M", "y|Y"], "and")) apo.setting.headerTitle.format = "DDD, MMM dd, yyyy";
                    else apo.setting.headerTitle.format = apo.setting.dateTimeFormat;
                } else if (apo.tmp.sDateTimeMode === "time") {
                    if (apo._formatContains(apo.tmp.sArrDateTimeFormat, ["h", "m"], "and") && apo._formatContains(apo.tmp.sArrDateTimeFormat, ["a", "A"], "or")) apo.setting.headerTitle.format = "hh:mm " + apo._getFormatForComponent("meridiem");
                    else if (apo._formatContains(apo.tmp.sArrDateTimeFormat, ["H", "m"], "and")) apo.setting.headerTitle.format = "HH:mm";
                    else apo.setting.headerTitle.format = apo.setting.dateTimeFormat;
                }
            }
        ...
        __setDataSourceArrayForComponent: function (sCompName, sCompFormat) {
            ...
            if (sCompName === "day") {
                ...
                else iStartValue = iTotalYears % 2 === 0 ? oSelectedDate.y - iStepYears - 1 : oSelectedDate.y - iStepYears;
                ...
                if (!apo.setting.roundOff) {
                    ...
                    while (iStartHour - apo.setting.intervals.h >= 0) iStartHour -= apo.setting.intervals.h;
                }
                ...
                if (!apo.setting.roundOff) {
                    ...
                    while (iStartMinute - apo.setting.intervals.m >= 0) iStartMinute -= apo.setting.intervals.m;
                }
                ...
                if (!apo.setting.roundOff) {
                    ...
                    while (iStartSeconds - apo.setting.intervals.s >= 0) iStartSeconds -= apo.setting.intervals.s;
                }
        ...
        _getRegexComponentForFormat: function (sInRegex, sFormat) {
			...
			*/
                ...
                else if (sFormat === "aa") sInRegex += apo.setting.i18n.meridiem.aa.join("|");
                else if (sFormat === "A") sInRegex += apo.setting.i18n.meridiem.A.join("|");
                else if (sFormat === "AA") sInRegex += apo.setting.i18n.meridiem.AA.join("|");
        ...
        _parseInputDateTime: function (sDate) {
            ...
            if (typeof sDate === "string") {
                ...
                for (iTempIndex = 0; iTempIndex < iArrDateTimeFormatComps.length; iTempIndex++) {
                    ...
                    if (sFormat.search(/D|d|M|y|Y|H|h|m|s|A|a/, "") !== -1) oDate = apo._setInputDateTimeValue(sFormat, sDTComp, oDate);
                }

                if ($.CF.isValid(oDate.h)) {
                    if (($.CF.compareStrings(oDate.me, "AM") || $.CF.compareStrings(oDate.sm, "A")) && oDate.h === 12) oDate.H = 0;
                    else if (($.CF.compareStrings(oDate.me, "PM") || $.CF.compareStrings(oDate.sm, "P")) && oDate.h < 12) oDate.H = oDate.h + 12;
        ...
        _setInputDateTimeValue: function (sDateTimeFormat, sDateTimeValue, oThisDate) {
            ...
            if (apo._isSupportedFormat(sDateTimeFormat)) {
                if (sDateTimeFormat === "d" || sDateTimeFormat === "dd") {
                    ...
                    if (oThisDate.y > iMaxSuffix) oThisDate.y = (iMaxPrefix - 1) * 100 + oThisDate.y;
                    ...
                    if ($.CF.isValid(sDateTimeValue)) {
                        ...
                        else if (sDateTimeValue.search(/P/gi, "") !== -1) oThisDate.me = "P";
                    }
                } else if (sDateTimeFormat === "aa" || sDateTimeFormat === "AA") {
                    if ($.CF.isValid(sDateTimeValue)) {
                        if (sDateTimeValue.search(/AM/gi, "") !== -1) oThisDate.me = "AM";
                        else if (sDateTimeValue.search(/PM/gi, "") !== -1) oThisDate.me = "PM";
                    }
                }
            }
        ...
        formatOutputDates: function (dDate, oFormat) {
            ...
            if ($.CF.isValid(oFormat)) {
                if (typeof oFormat === "string") sArrFormat = apo._setDateTimeFormatComponentsArray(oFormat);
                else if (typeof oFormat === "object") sArrFormat = oFormat;
                else sArrFormat = apo.tmp.diffDateTimeFormats ? apo.tmp.sArrInputDateTimeFormat : apo.tmp.sArrDateTimeFormat;
            } else sArrFormat = apo.tmp.diffDateTimeFormats ? apo.tmp.sArrInputDateTimeFormat : apo.tmp.sArrDateTimeFormat;
        ...
        parseDisableValues: function () {
            ...
            if ($.CF.isValid(apo.tmp.oMinMax.min) && $.CF.isValid(apo.tmp.oMinMax.max)) {
                if (apo.tmp.sDateTimeMode === "date") {
                    if (!(apo.compareDates(apo.tmp.selectedDate, apo.tmp.oMinMax.min) >= 1 && apo.compareDates(apo.tmp.selectedDate, apo.tmp.oMinMax.max) <= -1)) bIsOutOfBounds = true;
                } else if (apo.tmp.sDateTimeMode === "time") {
                    if (!(apo.compareTimes(apo.tmp.selectedDate, apo.tmp.oMinMax.min) >= 1 && apo.compareTimes(apo.tmp.selectedDate, apo.tmp.oMinMax.max) <= -1)) bIsOutOfBounds = true;
                } else if (apo.tmp.sDateTimeMode === "datetime") {
                    if (!(apo.compareDateTimes(apo.tmp.selectedDate, apo.tmp.oMinMax.min) >= 1 && apo.compareDateTimes(apo.tmp.selectedDate, apo.tmp.oMinMax.max) <= -1)) bIsOutOfBounds = true;
                }
                ...
                if (apo.tmp.sDateTimeMode === "date") {
                    if (apo.compareDates(apo.tmp.selectedDate, apo.tmp.oMinMax.min) < -1) bIsOutOfBounds = true;
                } else if (apo.tmp.sDateTimeMode === "time") {
                    if (apo.compareTimes(apo.tmp.selectedDate, apo.tmp.oMinMax.min) < -1) bIsOutOfBounds = true;
                } else if (apo.tmp.sDateTimeMode === "datetime") {
                    if (apo.compareDateTimes(apo.tmp.selectedDate, apo.tmp.oMinMax.min) < -1) bIsOutOfBounds = true;
                }
                ...
                if (apo.tmp.sDateTimeMode === "date") {
                    if (apo.compareDates(apo.tmp.selectedDate, apo.tmp.oMinMax.max) > 1) bIsOutOfBounds = true;
                } else if (apo.tmp.sDateTimeMode === "time") {
                    if (apo.compareTimes(apo.tmp.selectedDate, apo.tmp.oMinMax.max) > 1) bIsOutOfBounds = true;
                } else if (apo.tmp.sDateTimeMode === "datetime") {
                    if (apo.compareDateTimes(apo.tmp.selectedDate, apo.tmp.oMinMax.max) > 1) bIsOutOfBounds = true;
                }
            ...
            if (apo.tmp.sDateTimeMode === "date") apo.tmp.oArrPDisable.date.push(apo.tmp.oMinMax);
            else if (apo.tmp.sDateTimeMode === "time") apo.tmp.oArrPDisable.time.push({ day: [], val: [apo.tmp.oMinMax] });
            else if (apo.tmp.sDateTimeMode === "datetime") apo.tmp.oArrPDisable.datetime.push(apo.tmp.oMinMax);
            ...
            if ($.CF.isValid(apo.setting.disableValues)) {
                ...
                if ($.CF.isValid(apo.setting.disableValues.date) && apo.setting.disableValues.date.length > 0) {
                    for (iTempIndex = 0; iTempIndex < apo.setting.disableValues.date.length; iTempIndex++) {
                        ...
                        if ($.CF.isValid(oOutDate)) apo.tmp.oArrPDisable.date.push(oOutDate);
                    }
                }
                ...
                if ($.CF.isValid(apo.setting.disableValues.datetime) && apo.setting.disableValues.datetime.length > 0) {
                    for (iTempIndex1 = 0; iTempIndex1 < apo.setting.disableValues.datetime.length; iTempIndex1++) {
                        ...
                        if ($.CF.isValid(oOutDateTime)) apo.tmp.oArrPDisable.datetime.push(oOutDateTime);
                    }
                }
        ...
        __setSelectedDateTimeInComponent: function () {
            ...
            for (iTempIndex = 0; iTempIndex < apo.tmp.numOfComp; iTempIndex++) {
                ...
                if (oComp.name === "date") {
                    ...
                    if (oComp.format === "h" || oComp.format === "hh") sValue = oSelectedDate.h;
                    else if (oComp.format === "H" || oComp.format === "HH") sValue = oSelectedDate.H;
        ...
        __getSelectedDate: function (bGetObject) {
            ...
            for (iTempIndex = 0; iTempIndex < apo.tmp.numOfComp; iTempIndex++) {
                ...
                if (oComp.name === "date") {
                    ...
                    } else oNewSelectedDate.H = isNaN(iValue) ? oNewSelectedDate.H : iValue;
                } else if (oComp.name === "minutes") {
                    oNewSelectedDate.m = isNaN(iValue) ? oNewSelectedDate.m : iValue;
                } else if (oComp.name === "seconds") {
	...
	*/
        ...
        _findValidSelectedDate: function (bIsBefore, dDate, sType) {
            ...
            if (sType === "day" || sType === "date") {
                ...
                do {
                    if (bIsBefore) dDate = new Date(dDate.getTime() - $.AnyPicker.extra.iMS.d);
                    else dDate = new Date(dDate.getTime() + $.AnyPicker.extra.iMS.d);
                    if (apo.__validateSelectedDate(dDate, true, false)) {
                        if (
                            (!$.CF.isValid(apo.setting.minValue) || ($.CF.isValid(apo.setting.minValue) && apo.compareDates(apo.setting.minValue, dDate) <= 0)) &&
                            (!$.CF.isValid(apo.setting.maxValue) || ($.CF.isValid(apo.setting.maxValue) && apo.compareDates(apo.setting.maxValue, dDate) >= 0))
                        ) {
                            return dDate;
                        }
                    }
                ...
                do {
                    if (bIsBefore) dDate = new Date(dDate.getTime() - $.AnyPicker.extra.iMS.m * apo.setting.intervals.m);
                    else dDate = new Date(dDate.getTime() + $.AnyPicker.extra.iMS.m * apo.setting.intervals.m);
                    if (apo.__validateSelectedDate(dDate, true, false)) {
                        if (
                            (!$.CF.isValid(apo.setting.minValue) || ($.CF.isValid(apo.setting.minValue) && apo.compareTimes(apo.setting.minValue, dDate) <= 0)) &&
                            (!$.CF.isValid(apo.setting.maxValue) || ($.CF.isValid(apo.setting.maxValue) && apo.compareTimes(apo.setting.maxValue, dDate) >= 0))
                        ) {
                            return dDate;
                        }
                    }
                ...
                do {
                    ...
                    if (apo.__validateSelectedDate(dDate, true, false)) {
                        if (
                            (!$.CF.isValid(apo.setting.minValue) || ($.CF.isValid(apo.setting.minValue) && apo.compareDateTimes(apo.setting.minValue, dDate) <= 0)) &&
                            (!$.CF.isValid(apo.setting.maxValue) || ($.CF.isValid(apo.setting.maxValue) && apo.compareDateTimes(apo.setting.maxValue, dDate) >= 0))
                        ) {
                            return dDate;
                        }
                    }
        ...
        __setDaysOfMonthInDatePicker: function () {
            ...
            if (iDateComp !== null) {
                ...
                for (iTempIndex = iNoOfDays + 1; iTempIndex <= 31; iTempIndex++) {
                    ...
                    if (!bHasAria) bHasAria = $oHiddenElem.attr("aria-selected") === "true" ? true : false;
                }
        ...
        setDateInFormat: function (oInput, sType) {
            ...
            if (oInput.date === undefined && oInput.iDate === undefined) oInput.date = apo._getCurrentDate();
            ...
            var dDate;
            if (!$.CF.isValid(sType)) dDate = new Date(oInput.iDate.y, oInput.iDate.M, oInput.iDate.d, oInput.iDate.H, oInput.iDate.m, oInput.iDate.s, oInput.iDate.ms);
            else if (sType === "START") dDate = new Date(oInput.iDate.y, oInput.iDate.M, oInput.iDate.d, 0, 0, 0, 0);
            else if (sType === "END") dDate = new Date(oInput.iDate.y, oInput.iDate.M, oInput.iDate.d, 23, 59, 59, 999);
        ...
        _getTZOffsetInMS: function (sTZOffset) {
            var apo = this;
            var iOffsetMS = 0;
            if (sTZOffset === undefined || sTZOffset === "" || sTZOffset === null) iOffsetMS = -($.AnyPicker.extra.dToday.getTimezoneOffset() * $.AnyPicker.extra.iMS.m);
            else {
        ...
        _normalizeDateTime: function (dInputDate, sFunction, sUnit) {
            ...
            switch (sUnit) {
                case "s":
                    {
                        if (sFunction === "START") dOutputDate = new Date(iArrInput.y, iArrInput.M, iArrInput.d, iArrInput.H, iArrInput.m, 0, 0);
                        else if (sFunction === "END") dOutputDate = new Date(iArrInput.y, iArrInput.M, iArrInput.d, iArrInput.H, iArrInput.m, 59, 999);
                    }
                    break;
                case "m":
                    {
                        if (sFunction === "START") dOutputDate = new Date(iArrInput.y, iArrInput.M, iArrInput.d, iArrInput.H, 0, 0, 0);
                        else if (sFunction === "END") dOutputDate = new Date(iArrInput.y, iArrInput.M, iArrInput.d, iArrInput.H, 59, 59, 999);
                    }
                    break;
                case "h":
                case "T":
                    {
                        if (sFunction === "START") dOutputDate = new Date(iArrInput.y, iArrInput.M, iArrInput.d, 0, 0, 0, 0);
                        else if (sFunction === "END") dOutputDate = new Date(iArrInput.y, iArrInput.M, iArrInput.d, 23, 59, 59, 999);
                    }
                    break;
                case "d":
                case "dE":
                    {
                        if (sFunction === "START") dOutputDate = new Date(iArrInput.y, iArrInput.M, 1, 0, 0, 0, 0);
                        else if (sFunction === "END") dOutputDate = new Date(iArrInput.y, iArrInput.M, apo._getNumberOfDaysOfMonth(iArrInput.M, iArrInput.y), 0, 0, 0, 0);
                    }
                    break;
                case "M":
                case "ME":
                ...
                case "yE":
                    {
                        if (sFunction === "START") dOutputDate = new Date(iArrInput.y, 0, 1, 0, 0, 0, 0);
                        else if (sFunction === "END") dOutputDate = new Date(iArrInput.y, 11, apo._getNumberOfDaysOfMonth(11, iArrInput.y), 0, 0, 0, 0);
                    }
                    break;
            }

            if (sUnit === "dE" || sUnit === "ME" || sUnit === "yE") dOutputDate = apo._normalizeDateTime(dOutputDate, "END", "T");
        ...
        getNumberStringInFormat: function (iNumber, iChars, bIsLocalized) {
            ...
            if (iChars !== 0) {
                for (iTempIndex = 0; iTempIndex < iChars - iNumberLength; iTempIndex++) sFormattedString += bIsLocalized ? apo.setting.i18n.numbers[0] : "0";
            }
            if (!bIsLocalized) sFormattedString += sNumber;
            else {
                for (iTempIndex = 0; iTempIndex < iNumberLength; iTempIndex++) sFormattedString += apo.setting.i18n.numbers[parseInt(sNumber.charAt(iTempIndex))];
            }
