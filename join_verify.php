...
<div class="container sub_pg">
    <div class="mt-4">
        <p class="tit_h1 wh_pre line_h1_3"><?= $translations['txt_sent_verification_code'] ?></p>
            ...
            <div class="mt-5">
                <div class="ip_wr mt_hp_chk_msg">
                    ...
                    <div class="form-row mt_06">
                        <div class="col-12">
                            <input type="tel" class="form-control input_time_input" placeholder="<?= $translations['txt_six_placeholder'] ?>" name="mt_num" id="mt_num" maxlength="6" autocomplete="off">
                ...
                <div class="ip_wr mt-5 mt_hp_msg">
                    <div class="ip_tit">
                        <h5 class=""><?= $translations['txt_verification_code_sent'] ?></h5>
                    </div>
                    <input type="tel" class="form-control" placeholder="<?= $translations['txt_phone_placeholder'] ?>" id="mt_hp" name="mt_hp" value="<?= $_GET['phoneNumber'] ?>" readonly>
                    <div class="form-text ip_invalid"><i class="xi-error-o"></i> <?= $translations['txt_check_phone_number'] ?></div>
                    <button type="button" onclick="check_hp('send', 'join')" class="btn fs_12 fc_primary rounded-pill bg_secondary text-center px_12 py_07 text_dynamic w_fit h_fit_im d-flex align-items-center mt-3" id="re_send_btn"><?= $translations['txt_no_verification_code'] ?> <i class="xi-arrow-right ml-2"></i></button>
                </div>
            </div>
            <div class="b_botton">
                <button type="submit" class="btn w-100 rounded btn-primary btn-lg btn-block " id="auth_check_button" onclick="check_hp('auth');"><?= $translations['txt_entered'] ?></button>
