                                ...
                                <div class="float-right form-inline">
                                    <div class="form-group mx-1">
                                        <select name="obj_sel_search" id="obj_sel_search" class="form-control form-control-sm">
                                            ...
                                            <option value="a1.sgt_title">그룹명</option>
                                            <option value="a1.sgt_code">초대코드</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group mx-1">
                                        <input type="button" class="btn btn-secondary" value="초기화" onclick="f_localStorage_reset_go('./group_list');" />
                                    </div>
                                </div>
                            </div>
                        </div>
