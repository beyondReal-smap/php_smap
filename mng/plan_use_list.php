...
<div class="content-wrapper">
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">유료플랜 이용내역</h4>
                    <form method="post" name="frm_list" id="frm_list" onsubmit="return false;">
                        <input type="hidden" name="act" id="act" value="list" />
                        <input type="hidden" name="obj_list" id="obj_list" value="plan_list_box" />
                        <input type="hidden" name="obj_frm" id="obj_frm" value="frm_list" />
                        <input type="hidden" name="obj_uri" id="obj_uri" value="./plan_update" />
                        ...
                        <div class="row no-gutters mb-2">
                            ...
                            <div class="col-xl-12">
                                <div class="float-right form-inline">
                                    ...
                                    <div class="form-group mx-1">
                                        <select name="sel_ot_pay_type" id="sel_ot_pay_type" class="form-control form-control-sm">
                                            <option value="">신규가입여부</option>
                                    ...
                                    <div class="form-group mx-1">
                                        <select name="obj_sel_search" id="obj_sel_search" class="form-control form-control-sm">
                                            ...
                                            <option value="a2.mt_name">이름</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group mx-1">
                                        <input type="button" class="btn btn-secondary" value="초기화" onclick="f_localStorage_reset_go('./plan_use_list');" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <script>
                        ...
                        <?php } ?>
                        <?php if ($_POST['sel_ot_pay_type']) { ?>
                            $('#sel_ot_pay_type').val('<?= $_POST['sel_ot_pay_type'] ?>');
                        <?php } ?>
                    </script>

                    <div id="plan_list_box"></div>
                </div>
            </div>
        </div>
    </div>
