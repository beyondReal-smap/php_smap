...
<div class="content-wrapper">
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">쿠폰사용내역</h4>
                    <form method="post" name="frm_list" id="frm_list" onsubmit="return false;">
                        <input type="hidden" name="act" id="act" value="coupon_use_list" />
                        <input type="hidden" name="obj_list" id="obj_list" value="coupon_use_list_box" />
                                ...
                                <div class="float-right form-inline">
                                    ...
                                    <div class="form-group mx-1">
                                        <select name="obj_sel_search" id="obj_sel_search" class="form-control form-control-sm">
                                            ...
                                            <option value="a2.mt_id">사용회원 아이디</option>
                                            <option value="a2.mt_name">사용회원 이름</option>
                                            <option value="a1.coupon_code">쿠폰번호</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group mx-1">
                                        <input type="button" class="btn btn-secondary" value="초기화" onclick="f_localStorage_reset_go('./coupon_use_list');" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="coupon_use_list_box"></div>
                </div>
            </div>
        </div>
    </div>
