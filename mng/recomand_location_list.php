...
<div class="content-wrapper">
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">추천장소</h4>
                    <form method="post" name="frm_list" id="frm_list" onsubmit="return false;">
                        <input type="hidden" name="act" id="act" value="list" />
                        <input type="hidden" name="obj_list" id="obj_list" value="recomand_location_list_box" />
                        <input type="hidden" name="obj_frm" id="obj_frm" value="frm_list" />
                        <input type="hidden" name="obj_uri" id="obj_uri" value="./recomand_location_update" />
                            ...
                            <div class="col-xl-4">
                                <div class="float-left form-inline">
                                    <div class="form-group mx-1">
                                        <input type="button" class="btn btn-warning btn-sm text-white" value="엑셀양식 다운로드" onclick="gourl('../img/excel/excel_guide_20231218.xls');" />
                                    </div>
                                    <div class="form-group mx-1">
                                        <input type="button" class="btn btn-success btn-sm" value="엑셀 업로드" onclick="$('#excel_file').trigger('click');" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-8">
                                <div class="float-right form-inline">
                                    <div class="form-group mx-1">
                                        <select name="obj_sel_rlt_cate" id="obj_sel_rlt_cate" class="form-control form-control-sm">
                                    ...
                                    <div class="form-group mx-1">
                                        <select name="obj_sel_search" id="obj_sel_search" class="form-control form-control-sm">
                                            ...
                                            <option value="a1.rlt_title">추천장소명</option>
                                            <option value="a1.rlt_add1">주소</option>
                                            <option value="a1.rlt_add2">상세주소</option>
                                            <option value="a1.rlt_tel1">연락처</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group mx-1">
                                        <input type="button" class="btn btn-secondary" value="초기화" onclick="f_localStorage_reset_go('./recomand_location_list');" />
                                    </div>

                                    <div class="form-group mx-1">
                                        <input type="button" class="btn btn-primary" value="신규등록" onclick="f_localStorage_reset_go('./recomand_location_form');" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="recomand_location_list_box"></div>
                </div>
            </div>
        </div>
    </div>
