            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" name="frm_list" id="frm_list" onsubmit="return false;">
                        ...
                        <input type="hidden" name="obj_list" id="obj_list" value="member_retire_list_box" />
                        <input type="hidden" name="obj_frm" id="obj_frm" value="frm_list" />
                        <input type="hidden" name="obj_uri" id="obj_uri" value="./member_retire_update" />
                        ...
                        <div class="row no-gutters mb-2">
                            ...
                            <div class="col-xl-9">
                                <div class="float-right form-inline">
                                    ...
                                    <div class="form-group mx-1">
                                        <input type="button" class="btn btn-secondary" value="초기화" onclick="f_localStorage_reset_go('./member_retire_list');" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="member_retire_list_box"></div>
                </div>
            </div>
        </div>
    </div>
